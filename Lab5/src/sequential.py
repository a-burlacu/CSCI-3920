...
PROGRAM_TYPE = "SEQUENTIAL"  # Change for other types.
...
class WordCount:
    ...
    def __count_line_words(self, line : str):
        ...
        words_wo_stopwords = [word for word in words if word not in self.all_stopwords and re.fullmatch("[A-Z]*[a-z]*", word)]
